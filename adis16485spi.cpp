...
int adis16485spi::spiOpen(std::string devspi){
    int statusVal = -1;
 ...
 * "data".
 * ******************************************************************/
int adis16485spi::spiWriteRead( unsigned char *data, int length){
 ...
 * ***********************************************/
adis16485spi::adis16485spi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord){
    this->mode = spiMode ;
